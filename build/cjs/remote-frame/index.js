...
var createCapturedContextComponent = function createCapturedContextComponent() {
  ...
  var CapturedContextComponent = function (_Component) {
    ...
    _createClass(CapturedContextComponent, [{
      ...
      value: function componentDidMount() {
        var renderInRemote = this.context.callBackContainer.renderInRemote;
        var children = this.props.children;


        doRemoteRender(renderInRemote, this.context, _extends({ callBackContainer: _propTypes2.default.object }, contextTypes), children);
      }
    }, {
      key: 'shouldComponentUpdate',
      value: function shouldComponentUpdate(nextProps) {
        return !(0, _equals2.default)(this.props.children, nextProps.children);
      }
    }, {
  ...
  CapturedContextComponent.contextTypes = _extends({
    callBackContainer: _propTypes2.default.object
  }, contextTypes);
  ...
  _createClass(RemoteFrame, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.context.callBackContainer != null) {
        this.context.callBackContainer.subscribe(function () {
    ...
    value: function render() {
      if (this.CapturedContextComponent != null) {
        return _react2.default.createElement(this.CapturedContextComponent, this.props);
      } else {
...
RemoteFrame.contextTypes = {
  callBackContainer: _propTypes2.default.object,
  remoteFrameContextTypes: _propTypes2.default.object
};
