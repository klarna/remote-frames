...
var _GlobalTarget = require('./GlobalTarget');

var _GlobalTarget2 = _interopRequireDefault(_GlobalTarget);
...
var RemoteFramesProvider = function (_Component) {
  ...
  _createClass(RemoteFramesProvider, [{
    ...
    value: function renderGlobalTarget(targetDomElement) {
      (0, _reactDom.render)(_react2.default.createElement(_GlobalTarget2.default, {
...
exports.default = RemoteFramesProvider;